...
str_angulo      db     "Insert Angle: "  ;msg para exibir angulo
TAM_ANGULO      equ     $ - str_angulo	 ;tamanho da msg do angulo a exibir
						 

str_resultado   db      "Result = "	         ;msg para exibir resultado	
...
str_funcao      db      "Select the operator (1- sin, 2- cos, 3- tan, 4- cotan, 5- asin, 6- acos, 7- atan, 8- acos): "
